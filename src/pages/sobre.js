...
export default function Sobre() {
    ...
    `)
    const { titlesobre, paragraphblog, paragraphsobre, paragraphprojetos, paragraphquemsoueu } = data.alldata.sobres[0]
    ...
    return (
        <S.ContainerSobre>
            ...
            <S.Projetos><a href="/site"> Projetos{site}</a> </S.Projetos>
            <Footer />
        </S.ContainerSobre>
    )
}